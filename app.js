...
/**
 * Custom Middle Routes
 */
app.get('/faq', homeController.faq);
app.get('/status', passportConfig.isAuthenticated, statusMonitor);
app.get('/join', passportConfig.isAuthenticated, chatController.joinChat);
app.get('/chat', passportConfig.isAuthenticated, chatController.joinChat);
app.get('/new', passportConfig.isAuthenticated, chatController.createNewChat);
app.get('/chat/:id', passportConfig.isAuthenticated, chatController.getChatById);
app.get('/chat/:id/:timestamp', passportConfig.isAuthenticated, chatController.getChatById);
app.post('/chat/:id', passportConfig.isAuthenticated, chatController.postChatById);
